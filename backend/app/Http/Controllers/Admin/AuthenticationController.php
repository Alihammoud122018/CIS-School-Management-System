    ...
    */
    ...
    public function login(AuthenticationRequest $request)
    {
        try{
            ...
            $user = Auth::user();
            $cookie = cookie('jwt', $token, config('jwt.ttl') * 2, null, null, true, false, false, "none");
            return response()->json(['success'=>true,'message' => __('Logged In Succesfully'), 'user' => $user, 'token' => $token])->withCookie($cookie);
